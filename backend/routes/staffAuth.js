...
router.post('/addstaff', avatarUpload, staffValidates, stuffValidation, avatarValidation, addStaff);
...
router.put('/updatestaff', avatarUpload, stuffValidation, avatarValidation, updateStaff);
