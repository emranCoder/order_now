        ...
        <div className="container overflow-hidden">
          <div className="all-order-box mt-5 ">
            <div className="flex justify-between content-center">
              ...
              <label className="input mr-3 max-sm:w-3/5 max-sm:h-9  h-10 rounded-full  input-bordered input-md flex focus-within:outline-none focus-within:border-sky-500  items-center gap-2">
                <input
                  type="text"
